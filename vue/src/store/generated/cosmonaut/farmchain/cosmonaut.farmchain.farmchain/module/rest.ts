 ...
 */
export interface FarmchainQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: FarmchainParams;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/cosmonaut/farmchain/farmchain/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<FarmchainQueryParamsResponse, RpcStatus>({
      path: `/cosmonaut/farmchain/farmchain/params`,
      method: "GET",
      format: "json",
      ...params,
    });
